...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var dx = determineDx(document.querySelectorAll(".randomPizzaContainer")[i], size);//Moved outside of loop
    var newwidth = (document.querySelectorAll(".randomPizzaContainer")[i].offsetWidth + dx) + 'px';//Moved outside of loop
