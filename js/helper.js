...
*/
var HTMLheaderName = '<h1 id="name" class="title-super">%data%</h1>';
var HTMLheaderRole = '<h3 id="role" class="title-center">%data%</h3><hr>';

var HTMLPhone = '<img class="social-logo img-responsive pull-right flex-item" src=images/Telephone-icon.png data-toggle="modal" data-target="#phone" alt="Phone icon"></a>';
var HTMLemail = '<a href=mailto:%data%><img class="social-logo img-responsive pull-right flex-item" src=images/mail-black-icon.png alt="email icon"></a>';
...
var HTMLprojectImage = '<img src="%data%"><p>';
...
var HTMLschoolUrl = '<p><a href="#">%data%</a>';

var HTMLonlineClasses = '<h3>Online Classes</h3>';
var HTMLonlineTitle = '<a href="#">%data%';
var HTMLonlineSchool = ' - %data%</a>';
var HTMLonlineDates = '<div class="date-text">%data%</div>';
var HTMLonlineURL = '<a href="#">%data%</a><p>';
