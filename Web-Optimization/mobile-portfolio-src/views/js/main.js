...
var resizePizzas = function(size) {
  ...
  function changeSliderLabel(size) {
    switch(size) {
      case "1":
        document.getElementById("pizzaSize").innerHTML = "Small";//Changed to faster getElementByID
        return;
      case "2":
        document.getElementById("pizzaSize").innerHTML = "Medium";//Changed to faster getElementByID
        return;
      case "3":
        document.getElementById("pizzaSize").innerHTML = "Large";//Changed to faster getElementByID
        return;
      default:
  ...
  function determineDx (elem, size) {
    ...
    var windowWidth = document.getElementById("randomPizzas").offsetWidth;//Changed to faster getElementsByID
  ...
  //Change-Moved items out of For loop and used getElementsByClassName
...
//Change-Moved var pizzasDiv outside of loop
...
function updatePositions() {
  ...
  var scrollTop = document.body.scrollTop/1250;//Changed- Move outside For loop
  var items = document.getElementsByClassName('mover');//Change- used more effecient getElementsByClassName
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0, elem; i < p; i++) {//Change-used formule to automatically determine how many pizzas are needed
